...
public class LockUserAccounts extends psUtility {

	/**
	 * Test Name : How to Lock a User account Developer : Srinivas Description :
	 * Login with TA and select user in manage user page and lock the account .
	 * 
	 * Dependency : 1) Organization ID, Tenant Admin, Tenent user (User must me
	 * unlock) is required To execute the script 2) Set the connection.Property file
	 * in the folder Files>EnvironemntDetails>Connection.properties
	 * 
	 */
